...
},{}],"js/components/Dude.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $b59dee = exports.default || module.exports;
      
      if (typeof $b59dee === 'function') {
        $b59dee = $b59dee.options;
      }
    
        /* template */
        Object.assign($b59dee, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("li", { attrs: { title: _vm.title } }, [
    _c("article", [
      _vm._v("\n        " + _vm._s(_vm.name) + "\n        "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b59dee', $b59dee);
          } else {
            api.reload('$b59dee', $b59dee);
          }
        }
...
var app = new Vue({
  ...
  methods: {
    downloadDudes: function downloadDudes() {
      var _this = this;

      axios.get('https://api.myjson.com/bins/1gh8x2').then(function (response) {
        response.data.forEach(function (dude) {
          _this.characters.push(dude.who);
        });
      });
    }
  }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36415" + '/');
